...
class ListTransaksi extends StatefulWidget {
  ...
  const ListTransaksi({required this.transaksi, required this.delete, super.key});
      ...
      widget.transaksi.isEmpty
          ...
          ListView.builder(
            ...
            itemBuilder: (ctx, index){
              return ListTransaksiItem(transaksi: widget.transaksi[index], delete: widget.delete,);
            })
    );
  }
}
